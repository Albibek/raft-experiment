...
pub fn server_connection_preamble(id: ServerId, addr: &SocketAddr) -> Arc<Builder<HeapAllocator>> {
...
pub fn preamble_response(response: ConnectionResponse) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        let mut res = message.init_root::<preamble_response::Builder>();
        res.set_response(response);
    }
    Arc::new(message)
}

pub fn client_connection_preamble(id: ClientId) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        message
            .init_root::<connection_preamble::Builder>()
...
pub fn append_entries_response_stale_term(term: Term) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        let mut response = message
            .init_root::<message::Builder>()
...
pub fn request_vote_response_granted(term: Term) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        let mut response = message
            .init_root::<message::Builder>()
...
pub fn request_vote_response_stale_term(term: Term) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        let mut response = message
            .init_root::<message::Builder>()
...
pub fn request_vote_response_already_voted(term: Term) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        let mut response = message
            .init_root::<message::Builder>()
...
pub fn request_vote_response_inconsistent_log(term: Term) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        let mut response = message
            .init_root::<message::Builder>()
...
pub fn request_vote_response_internal_error(
    term: Term,
    error: &str,
) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
...
pub fn command_response_success(data: &[u8]) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        message
...
pub fn command_response_unknown_leader() -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        message
            .init_root::<client_response::Builder>()
...
pub fn command_response_not_leader(leader_hint: &SocketAddr) -> Arc<Builder<HeapAllocator>> {
    let mut message = Builder::new_default();
    {
        message
            .init_root::<client_response::Builder>()
